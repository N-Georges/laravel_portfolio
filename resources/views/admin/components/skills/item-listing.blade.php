                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#"
                                class="text-gray-700 hover:text-gray-900 ml-1 md:ml-2 text-sm font-medium">Skill</a>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">All Skills</h1>
        </div>
        <div class="block sm:flex items-center md:divide-x md:divide-gray-100">
            <form class="sm:pr-3 mb-4 sm:mb-0" action="#" method="GET" data-dashlane-rid="111675cfbb9a9dac"
                data-form-type="">
                <label for="products-search" class="sr-only">Search</label>
                <div class="mt-1 relative sm:w-64 xl:w-96">
                    <input type="text" name="email" id="products-search"
                        class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                        placeholder="Search for posts" data-dashlane-rid="8855f7a31748ec0d" data-form-type="">
                </div>
            </form>
            <div class="flex items-center sm:justify-end w-full">
                <div class="hidden md:flex pl-2 space-x-1">
                    ...
                    @if ($message = Session::get('success'))
                        <div class="text-green-600 flex justify-center items-center">
                            ...
                            <strong class="ml-1">{{ $message }}</strong>
                        </div>
                    @endif
                ...
                <a href="{{ route('skills.create') }}" data-modal-toggle="add-product-modal"
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($skill as $item)
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="p-4 whitespace-wrap text-base font-medium text-gray-900"><img
                                    class="h-12 w-12   mx-1"
                                    src={{ asset('images/svg/' . $item->logo) }} alt="avatar">
                                    </td>
                                <td class="p-4 whitespace-wrap text-base font-medium text-gray-900">
                                    {{ $item->title }}</td>
                                <td class="p-4 whitespace-wrap text-base font-medium text-gray-900">
                                    {{ $item->description }}</td>
                                ...
                                <td class="p-4 whitespace-nowrap space-x-2">
                                    ...
                                    <a href="{{ route('skills.show', $item->id) }}"
                                        class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
...
<div
    ...
    {{-- <span class="text-sm font-normal text-gray-500">Showing<span class="text-gray-900 ml-1 font-semibold">{{ count($skill) }}</span> of
    <span class="text-gray-900 font-semibold">{{ $skill->total()}}</span></span> --}}
</div>
