    ...
    <div class="mb-1 w-full">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#"
                                class="text-gray-700 hover:text-gray-900 ml-1 md:ml-2 text-sm font-medium">porject</a>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">All Projects</h1>
        </div>
        <div class="block sm:flex items-center md:divide-x md:divide-gray-100">
            ...
            <div class="flex items-center sm:justify-end w-full">
                ...
                <a href="{{ route('project.create') }}" data-modal-toggle="add-product-modal"
                        ...
                        @foreach ($project as $item)
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="p-4 whitespace-wrap text-base font-medium text-gray-900"><img
                                    ...
                                    src={{ asset('images/project/' . $item->image) }} alt="avatar">
                                    </td>
...
<div
    ...
    <div class="flex items-center mb-4 sm:mb-0">
        ...
        <span class="text-sm font-normal text-gray-500">Showing<span class="text-gray-900 ml-1 font-semibold">{{ count($project) }}</span> of
            <span class="text-gray-900 font-semibold">{{ count($project) }}</span></span>
    </div>
