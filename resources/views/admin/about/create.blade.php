    ...
    <form action="{{ route('about.store') }}" method="POST">
        ...
        <div class="min-h-screen md:px-20 pt-6">
            ...
            <div class=" rounded-md px-6 py-10 max-w-2xl mx-auto">
                ...
                <h1 class="text-center text-2xl font-bold text-gray-500 mb-10">CREATE POST</h1>
                @error('text_1')
                    <span class="text-red-600"><strong>{{ $message }}</strong></span>
                @enderror
                <textarea name="text_1" placeholder="Text_1" id="message" rows="4"
                ...
                @error('text_2')
                    <span class="text-red-600"><strong>{{ $message }}</strong></span>
                @enderror
                <textarea name="text_2" placeholder="Text_2" id="message" rows="4"
                    class="block p-2 mb-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></textarea>
                    @error('text_3')
                        <span class="text-red-600"><strong>{{ $message }}</strong></span>
                    @enderror
                <textarea name="text_3" placeholder="Text_3" id="message" rows="4"
                    class="block p-2 mb-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></textarea>
                ...
                @error('image')
                    <span class="text-red-600"><strong>{{ $message }}</strong></span>
                @enderror
                <div class="mt-1 mb-10 text-sm text-gray-500 dark:text-gray-300">A profile picture is useful
                    to confirm that you are talking about yourself</div>
